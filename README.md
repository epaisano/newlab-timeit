...
| ---------------------- | ---------------- | ---------------- | --------------------- |
| `check_palindrome_1`   | 3.96 msec per loop| 4.31 msec per loop| 64.1 msec per loop|
| `check_palindrome_2`   | 3.11 msec per loop| 2.99 msec per loop| 3.08 msec per loop|
